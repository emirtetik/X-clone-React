...
export default function AppearanceModal() {
    return (
        <div className="w-[600px]  ">
            <h6 className="mt-8 mb-3 text-center text-[23px] leading-7  font-extrabold">Görünümü özelleştir</h6>
            <div className="p-8 pt-0">
                 <p className="text-center text-[#71767b] leading-5 mb-5">
