      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 rounded-xl bg-black shadow-box  ">
        ...
        <Disclosure>
          ...
          <Disclosure.Panel className="text-gray-500">
           <Link to="/" className="flex items-center text-white gap-3 px-3 h-11 text-[15px] font-medium transition-colors hover:bg-[#eff3f41a]">
           <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
          <path fill="currentColor" d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z"></path>
          </svg>
           İstatistikler
           </Link>
          </Disclosure.Panel>
        ...
        <Disclosure>
          ...
          <Link to="/" className="flex items-center text-white gap-3 px-3 h-11 text-[15px] font-medium transition-colors hover:bg-[#eff3f41a]">
           <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
           <path fill="currentColor" d="M1.996 5.5c0-1.38 1.119-2.5 2.5-2.5h15c1.38 0 2.5 1.12 2.5 2.5v13c0 1.38-1.12 2.5-2.5 2.5h-15c-1.381 0-2.5-1.12-2.5-2.5v-13zm2.5-.5c-.277 0-.5.22-.5.5v13c0 .28.223.5.5.5h15c.276 0 .5-.22.5-.5v-13c0-.28-.224-.5-.5-.5h-15zm8.085 5H8.996V8h7v7h-2v-3.59l-5.293 5.3-1.415-1.42L12.581 10z"></path>
          </svg>
           Reklamlar
           </Link>
          </Disclosure.Panel>
        ...
        <Disclosure>
          ...
          <Link to="/" className="flex items-center text-white gap-3 px-3 h-11 text-[15px] font-medium transition-colors hover:bg-[#eff3f41a]">
           ...
           <Link to="/" className="flex items-center text-white gap-3 px-3 h-11 text-[15px] font-medium transition-colors hover:bg-[#eff3f41a]">
           <svg viewBox="0 0 24 24"width={18.75} height={18.75} ><path fill="currentColor" d="M14 12c0-1.1-.9-2-2-2-1.11 0-2 .9-2 2v2h2c1.1 0 2-.9 2-2z"></path></svg>
           Görünüm
           </Link>
           <Link to="/" className="flex items-center text-white gap-3 px-3 h-11 text-[15px] font-medium transition-colors hover:bg-[#eff3f41a]">
           <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
