...
export default function Footer() {
  return (
    <footer className="flex flex-wrap gap-2 px-4 mb-4">
      <Link
        to="/"
        className="text-[var(--color-base-secondary)] text-[13px] leading-4  hover:underline"
      >
        Hizmet Şartları
      </Link>
      <Link
    ...
    <Popover className="relative inline-flex leading-4">
        <Popover.Button className={"items-center outline-none text-[var(--color-base-secondary)] text-[13px] leading-4 hover:underline inline-flex"}>
        ...
        <Link
        to="/"
        className="px-4 py-3 font-bold leading-5  hover:bg-[var(--background-secondary)] transition-colors"
      >
        Hakkında
      </Link>
      <Link
    ...
    <p className="text-[var(--color-base-secondary)] text-[13px] leading-4">&copy; 2023 X Corp.</p>
    </div>
    </footer>
  );
}
