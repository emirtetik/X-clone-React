  ...
  return (
    ...
    >
      ...
      <Popover className="absolute  top-1.5 right-2 ">
        ...
        >
          <svg width={19} height={19} fill="#e7e9ea" viewBox="0 0 24 24">
            <path
              fill="currentColor"
        ...
        <Popover.Panel className="w-[380px] absolute grid top-2 right-0 overflow-hidden bg-black shadow-box rounded-xl  z-[1]  ">
